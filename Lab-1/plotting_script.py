...
filename     = "Schmitt_c_readings_Vo"              #filename : This is name of the file containing the x and y values
Plot_Title   =  "Schmitt Trigger"
x_axis_label = "Vin"
...
x_axis_colum_number = 3                     #this is column no. from which actual data start. It lowest value is 0.
