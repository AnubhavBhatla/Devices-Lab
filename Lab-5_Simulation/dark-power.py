...
filenames    = ["IV_dark_power_35.txt", "IV_dark_power_45.txt", "IV_dark_power_55.txt", "IV_dark_power_65.txt", "IV_dark_power_75.txt"]
Plot_Title   = "Dark I/V Power"
