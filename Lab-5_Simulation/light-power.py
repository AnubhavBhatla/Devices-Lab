...
filenames    = ["IV_light_power_35.txt", "IV_light_power_45.txt", "IV_light_power_55.txt", "IV_light_power_65.txt", "IV_light_power_75.txt"]
Plot_Title   = "Light I/V Power"
x_axis_label = "Voltage (V)"
y_axis_label = "Power (P)"
...
if __name__ == '__main__':
    ...
    plt.legend()
    plt.savefig("light-iv-power.png")
    plt.show()
